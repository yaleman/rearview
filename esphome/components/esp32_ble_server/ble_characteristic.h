...
class BLECharacteristic final {
 ...
 protected:
  ...
  // Local security delta: require authenticated encryption for every writable
  // custom characteristic instead of ESPHome's unauthenticated default.
  esp_gatt_perm_t permissions_ = ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE_ENC_MITM;
